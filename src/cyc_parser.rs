...
/// eval cyc substrings ...
pub fn eval_cyc_from_str(src: &str, sample_set: &sync::Arc<Mutex<SampleSet>>, parts_store: &sync::Arc<Mutex<PartsStore>>, out_mode: OutputMode) -> Result<Vec<Option<Expr>>, String> {
    parse_cyc(src)
