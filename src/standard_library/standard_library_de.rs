 ...
 * deutsche version
 */
pub fn define_standard_library_de() -> FunctionMap {
    ...
    // constructors
    standard_library.std_lib.insert("kern".to_string(), eval::constructors::nuc::nuc);
    standard_library.std_lib.insert("fully".to_string(), eval::constructors::fully::fully);
    standard_library.std_lib.insert("freundschaft".to_string(), eval::constructors::friendship::friendship);
    ...
    standard_library.std_lib.insert("schleife".to_string(), eval::constructors::r#loop::a_loop);
    standard_library.std_lib.insert("zerhacken".to_string(), eval::constructors::chop::chop);
    standard_library.std_lib.insert("herleiten".to_string(), eval::constructors::infer::infer);
    standard_library.std_lib.insert("regel".to_string(), eval::constructors::infer::rule);
    standard_library.std_lib.insert("lerne".to_string(), eval::constructors::learn::learn);
    standard_library.std_lib.insert("kreis".to_string(), eval::constructors::cyc::cyc);
    standard_library.std_lib.insert("blume".to_string(), eval::constructors::flower::flower);
    standard_library.std_lib.insert("etappen".to_string(), eval::constructors::stages::stages);
    standard_library.std_lib.insert("faktoren".to_string(), eval::constructors::facts::facts);
    standard_library.std_lib.insert("werte".to_string(), eval::constructors::vals::vals);

    // commands
    standard_library.std_lib.insert("einfrieren".to_string(), eval::commands::freeze_buffer);
    standard_library.std_lib.insert("lade-sample".to_string(), eval::commands::load_sample);
    standard_library.std_lib.insert("lade-wavematrix".to_string(), eval::commands::load_sample_as_wavematrix);
    standard_library.std_lib.insert("lade-sample-sets".to_string(), eval::commands::load_sample_sets);
    standard_library.std_lib.insert("lade-sample-set".to_string(), eval::commands::load_sample_set);
    standard_library.std_lib.insert("tmod".to_string(), eval::commands::tmod);
    standard_library.std_lib.insert("latenz".to_string(), eval::commands::latency);
    standard_library.std_lib.insert("bpm".to_string(), eval::commands::bpm);
    standard_library.std_lib.insert("standard-zeitabstand".to_string(), eval::commands::default_duration);
    ...
    standard_library.std_lib.insert("hall".to_string(), eval::commands::reverb);
    standard_library.std_lib.insert("echo".to_string(), eval::commands::delay);
    standard_library.std_lib.insert("export-dot".to_string(), eval::commands::export_dot);
    standard_library.std_lib.insert("einmal".to_string(), eval::commands::once);
    standard_library.std_lib.insert("step-part".to_string(), eval::commands::step_part);
    standard_library.std_lib.insert("leeren".to_string(), eval::commands::clear);
    standard_library.std_lib.insert("verbinde-visualisierung".to_string(), eval::commands::connect_visualizer);
    standard_library.std_lib.insert("aufnehmen".to_string(), eval::commands::start_recording);
    standard_library.std_lib.insert("stop-aufnahme".to_string(), eval::commands::stop_recording);
    standard_library.std_lib.insert("import-sample-set".to_string(), eval::commands::import_sample_set);
    standard_library.std_lib.insert("drucke".to_string(), eval::print::print);
    standard_library.std_lib.insert("lade-datei".to_string(), eval::commands::load_file);

    // progn and other constructs
    standard_library.std_lib.insert("progn".to_string(), eval::progn::progn);
    standard_library.std_lib.insert("vergleiche".to_string(), eval::megra_match::megra_match);
    ...
    standard_library.std_lib.insert("anhängen".to_string(), eval::vector::push);
    standard_library.std_lib.insert("map".to_string(), eval::map::map);
    standard_library.std_lib.insert("einfügen".to_string(), eval::map::insert);
    ...
    standard_library.std_lib.insert("zufälliges-sample".to_string(), eval::events::parameters::random_sample);
    standard_library.std_lib.insert("rands".to_string(), eval::events::parameters::random_sample);
        
    // some shorthands 
    standard_library.std_lib.insert("transponieren".to_string(), eval::events::parameters::transpose);
    standard_library.std_lib.insert("tpo".to_string(), eval::events::parameters::transpose);

    // dynpars
    standard_library.std_lib.insert("hüpf".to_string(), eval::dynpar::bounce);
    ...
    standard_library.std_lib.insert("ausklingen".to_string(), eval::dynpar::fade);

    // generator processors
    standard_library.std_lib.insert("birne".to_string(), eval::generator_processor::eval_pear);
    standard_library.std_lib.insert("apfel".to_string(), eval::generator_processor::eval_apple);
    standard_library.std_lib.insert("alle".to_string(), eval::generator_processor::eval_every);
    standard_library.std_lib.insert("leben".to_string(), eval::generator_processor::eval_lifemodel);
    standard_library.std_lib.insert("hemmen".to_string(), eval::generator_processor::eval_inhibit);
    standard_library.std_lib.insert("hearausstellen".to_string(), eval::generator_processor::eval_exhibit);
    ...
    // generator modifiers
    standard_library.std_lib.insert("eile".to_string(), eval::generator_modifier::eval_haste);
    standard_library.std_lib.insert("weile".to_string(), eval::generator_modifier::eval_relax);
    standard_library.std_lib.insert("wachse".to_string(), eval::generator_modifier::eval_grow);
    standard_library.std_lib.insert("wachse-n".to_string(), eval::generator_modifier::eval_grown);
    standard_library.std_lib.insert("schrumpf".to_string(), eval::generator_modifier::eval_shrink);
    standard_library.std_lib.insert("solidify".to_string(), eval::generator_modifier::eval_solidify);
    standard_library.std_lib.insert("verwische".to_string(), eval::generator_modifier::eval_blur);
    standard_library.std_lib.insert("schärfe".to_string(), eval::generator_modifier::eval_sharpen);
    standard_library.std_lib.insert("schüttel".to_string(), eval::generator_modifier::eval_shake);
    standard_library.std_lib.insert("überspringe".to_string(), eval::generator_modifier::eval_skip);
    standard_library.std_lib.insert("spule-zurück".to_string(), eval::generator_modifier::eval_rewind);
    standard_library.std_lib.insert("rnd".to_string(), eval::generator_modifier::eval_rnd);
    standard_library.std_lib.insert("wdh".to_string(), eval::generator_modifier::eval_rep);
    standard_library.std_lib.insert("rück".to_string(), eval::generator_modifier::eval_reverse);
    standard_library.std_lib.insert("behalte".to_string(), eval::generator_modifier::eval_keep);
