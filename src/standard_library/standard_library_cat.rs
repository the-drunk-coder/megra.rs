 ...
 * versió català
 */
pub fn define_standard_library_cat() -> FunctionMap {
    ...
    standard_library.std_lib.insert("amistat".to_string(), eval::constructors::friendship::friendship);
    ...
    standard_library.std_lib.insert("tallar".to_string(), eval::constructors::chop::chop);
    ...
    standard_library.std_lib.insert("aprèn".to_string(), eval::constructors::learn::learn);
    standard_library.std_lib.insert("cicle".to_string(), eval::constructors::cyc::cyc);
    standard_library.std_lib.insert("flor".to_string(), eval::constructors::flower::flower);
    standard_library.std_lib.insert("etapes".to_string(), eval::constructors::stages::stages);
    ...
    // commands
    standard_library.std_lib.insert("gela".to_string(), eval::commands::freeze_buffer);
    standard_library.std_lib.insert("carrega-sample".to_string(), eval::commands::load_sample);
    standard_library.std_lib.insert("load-wavematrix".to_string(), eval::commands::load_sample_as_wavematrix);
    standard_library.std_lib.insert("carrega-sample-sets".to_string(), eval::commands::load_sample_sets);
    standard_library.std_lib.insert("carrega-sample-set".to_string(), eval::commands::load_sample_set);
    ...
    standard_library.std_lib.insert("durada-defecte".to_string(), eval::commands::default_duration);
    ...
    standard_library.std_lib.insert("uncop".to_string(), eval::commands::once);
    standard_library.std_lib.insert("passa-part".to_string(), eval::commands::step_part);
    standard_library.std_lib.insert("aclareix".to_string(), eval::commands::clear);
    standard_library.std_lib.insert("connect-visualizer".to_string(), eval::commands::connect_visualizer);
    standard_library.std_lib.insert("grava".to_string(), eval::commands::start_recording);
    standard_library.std_lib.insert("para-gravar".to_string(), eval::commands::stop_recording);
    standard_library.std_lib.insert("import-sample-set".to_string(), eval::commands::import_sample_set);
    standard_library.std_lib.insert("imprimeix".to_string(), eval::print::print);
    standard_library.std_lib.insert("carrega-fitxer".to_string(), eval::commands::load_file);
    
    // progn and other constructs
    standard_library.std_lib.insert("progn".to_string(), eval::progn::progn);
    standard_library.std_lib.insert("aparella".to_string(), eval::megra_match::megra_match);
    ...
    standard_library.std_lib.insert("insereix".to_string(), eval::map::insert);
    ...
    standard_library.std_lib.insert("poma".to_string(), eval::generator_processor::eval_apple);
    ...
    standard_library.std_lib.insert("inhibeix".to_string(), eval::generator_processor::eval_inhibit);
    standard_library.std_lib.insert("exhibeix".to_string(), eval::generator_processor::eval_exhibit);

    // composition
    standard_library.std_lib.insert("cmp".to_string(), eval::compose::compose);
    standard_library.std_lib.insert("compon".to_string(), eval::compose::compose);
    ...
    standard_library.std_lib.insert("estén".to_string(), eval::generator_list::spread_list);

    // multiplyer
    standard_library.std_lib.insert("xestén".to_string(), eval::multiplyer::eval_xspread);
    standard_library.std_lib.insert("xdup".to_string(), eval::multiplyer::eval_xdup);
    
    // generator modifiers
    standard_library.std_lib.insert("dona-pressa".to_string(), eval::generator_modifier::eval_haste);
    standard_library.std_lib.insert("afluixa".to_string(), eval::generator_modifier::eval_relax);
    standard_library.std_lib.insert("creix".to_string(), eval::generator_modifier::eval_grow);
    standard_library.std_lib.insert("creix-n".to_string(), eval::generator_modifier::eval_grown);
    ...
    // arithmetic
    standard_library.std_lib.insert("afg".to_string(), eval::arithmetic::add);
    ...
    standard_library.std_lib.insert("parella".to_string(), eval::types::pair);
