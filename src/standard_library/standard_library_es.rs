 ...
 * version castellano 
 */
pub fn define_standard_library_es() -> FunctionMap {
    ...
    standard_library.std_lib.insert("alea".to_string(), eval::constructors::fully::fully);
    standard_library.std_lib.insert("amistad".to_string(), eval::constructors::friendship::friendship);
    standard_library.std_lib.insert("lin".to_string(), eval::constructors::linear::linear);
    standard_library.std_lib.insert("lineal".to_string(), eval::constructors::linear::linear);
    standard_library.std_lib.insert("bucle".to_string(), eval::constructors::r#loop::a_loop);
    standard_library.std_lib.insert("cortar".to_string(), eval::constructors::chop::chop);
    standard_library.std_lib.insert("inferir".to_string(), eval::constructors::infer::infer);
    standard_library.std_lib.insert("regla".to_string(), eval::constructors::infer::rule);
    standard_library.std_lib.insert("aprender".to_string(), eval::constructors::learn::learn);
    standard_library.std_lib.insert("ciclo".to_string(), eval::constructors::cyc::cyc);
    standard_library.std_lib.insert("flor".to_string(), eval::constructors::flower::flower);
    standard_library.std_lib.insert("etapas".to_string(), eval::constructors::stages::stages);
    ...
    // commands
    standard_library.std_lib.insert("helar".to_string(), eval::commands::freeze_buffer);
    standard_library.std_lib.insert("cargar-sample".to_string(), eval::commands::load_sample);
    standard_library.std_lib.insert("cargar-matriz-de-ondas".to_string(), eval::commands::load_sample_as_wavematrix);
    ...
    standard_library.std_lib.insert("latencia".to_string(), eval::commands::latency);
    standard_library.std_lib.insert("bpm".to_string(), eval::commands::bpm);
    standard_library.std_lib.insert("duracion-defecto".to_string(), eval::commands::default_duration);
    ...
    standard_library.std_lib.insert("unavez".to_string(), eval::commands::once);
    standard_library.std_lib.insert("paso-part".to_string(), eval::commands::step_part);
    standard_library.std_lib.insert("purgar".to_string(), eval::commands::clear);
    standard_library.std_lib.insert("conectar-visualizador".to_string(), eval::commands::connect_visualizer);
    standard_library.std_lib.insert("grabar".to_string(), eval::commands::start_recording);
    standard_library.std_lib.insert("parar-grabacion".to_string(), eval::commands::stop_recording);
    standard_library.std_lib.insert("import-sample-set".to_string(), eval::commands::import_sample_set);
    standard_library.std_lib.insert("imprimir".to_string(), eval::print::print);
    standard_library.std_lib.insert("cargar-archivo".to_string(), eval::commands::load_file);

    // progn and other constructs
    standard_library.std_lib.insert("progn".to_string(), eval::progn::progn);
    standard_library.std_lib.insert("emparejar".to_string(), eval::megra_match::megra_match);
    ...
    // some shorthands 
    standard_library.std_lib.insert("transponer".to_string(), eval::events::parameters::transpose);
    standard_library.std_lib.insert("tpo".to_string(), eval::events::parameters::transpose);

    // dynpars
    standard_library.std_lib.insert("rebotar".to_string(), eval::dynpar::bounce);
    ...
    standard_library.std_lib.insert("pera".to_string(), eval::generator_processor::eval_pear);
    standard_library.std_lib.insert("manzana".to_string(), eval::generator_processor::eval_apple);
    standard_library.std_lib.insert("cada".to_string(), eval::generator_processor::eval_every);
    standard_library.std_lib.insert("vida".to_string(), eval::generator_processor::eval_lifemodel);
    standard_library.std_lib.insert("inhibir".to_string(), eval::generator_processor::eval_inhibit);
    standard_library.std_lib.insert("exhibir".to_string(), eval::generator_processor::eval_exhibit);

    // composition
    standard_library.std_lib.insert("cmp".to_string(), eval::compose::compose);
    standard_library.std_lib.insert("componer".to_string(), eval::compose::compose);
    standard_library.std_lib.insert("ls".to_string(), eval::generator_list::generator_list);
    standard_library.std_lib.insert("lista".to_string(), eval::generator_list::generator_list);
    standard_library.std_lib.insert("difundir".to_string(), eval::generator_list::spread_list);

    // multiplyer
    standard_library.std_lib.insert("xdifundir".to_string(), eval::multiplyer::eval_xspread);
    standard_library.std_lib.insert("xdup".to_string(), eval::multiplyer::eval_xdup);
    
    // generator modifiers
    standard_library.std_lib.insert("dar-prisa".to_string(), eval::generator_modifier::eval_haste);
    standard_library.std_lib.insert("ralentizar".to_string(), eval::generator_modifier::eval_relax);
    standard_library.std_lib.insert("crecer".to_string(), eval::generator_modifier::eval_grow);
    standard_library.std_lib.insert("crecer-n".to_string(), eval::generator_modifier::eval_grown);
    standard_library.std_lib.insert("contraer".to_string(), eval::generator_modifier::eval_shrink);
    standard_library.std_lib.insert("solidificar".to_string(), eval::generator_modifier::eval_solidify);
    standard_library.std_lib.insert("difuminar".to_string(), eval::generator_modifier::eval_blur);
    standard_library.std_lib.insert("afilar".to_string(), eval::generator_modifier::eval_sharpen);
    standard_library.std_lib.insert("agitar".to_string(), eval::generator_modifier::eval_shake);
    standard_library.std_lib.insert("saltar".to_string(), eval::generator_modifier::eval_skip);
    standard_library.std_lib.insert("rebobinar".to_string(), eval::generator_modifier::eval_rewind);
    standard_library.std_lib.insert("aleatorizar".to_string(), eval::generator_modifier::eval_rnd);
    standard_library.std_lib.insert("rep".to_string(), eval::generator_modifier::eval_rep);
    standard_library.std_lib.insert("invertir".to_string(), eval::generator_modifier::eval_reverse);
    standard_library.std_lib.insert("mantener".to_string(), eval::generator_modifier::eval_keep);

    // arithmetic
    standard_library.std_lib.insert("agr".to_string(), eval::arithmetic::add);
    ...
    standard_library.std_lib.insert("par".to_string(), eval::types::pair);
